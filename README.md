# genpark-multi-tenant-gitlab-webhook-event-router-skill
...
> **GenPark AI Agent Skill** -- Multi-tenant GitLab webhook event router & CI/CD trigger (GitLab Webhook style)
